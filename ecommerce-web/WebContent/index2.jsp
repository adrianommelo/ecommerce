                        ...
                        <div class="row products">
                                ...
                                <div class="product">
                                    <div class="image" style="height: 264px;">
                                        <a href="shop-detail.html">
                                            <img src="resources/img/motog4_play_md.png" alt="" class="img-responsive image1">
                                        </a>
                                    </div>
                                    <!-- /.image -->
                                    <div class="text">
                                        <h3><a href="shop-detail.html">Smartphone Moto G4 Plus</a></h3>
                                        <p class="price">R$700.00</p>
                                        <a href="shop-detail.html" type="submit" class="btn btn-success">Comprar</a>
                                        <a href="shop-detail.html" type="submit" class="btn btn-info">Ver detalhes</a>
                                    </div>
                                    <!-- /.text -->
                                </div>
                                <!-- /.product -->
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    <div class="image" style="height: 264px;">
                                        <a href="shop-detail.html">
                                            <img src="resources/img/asuszenfone3_preto_md.jpg" alt="" class="img-responsive image1">
                                        </a>
                                    </div>
                                    <!-- /.image -->
                                    <div class="text">
                                        <h3><a href="shop-detail.html">Smartphone Asus Zenfone 3</a></h3>
                                        <p class="price"><del>R$1400.00</del> R$1100.00</p>
                                        <a href="shop-detail.html" type="submit" class="btn btn-success">Comprar</a>
                                        <a href="shop-detail.html" type="submit" class="btn btn-info">Ver detalhes</a>
                                    </div>
                                    <!-- /.text -->
