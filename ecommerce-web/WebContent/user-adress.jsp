									...
									<ul class="nav nav-pills nav-stacked category-menu">
										...
										<li><a href="user-account.jsp"> Minha Conta</a>
											<ul>
												...
												<li><a href="user-account-cancel.jsp">Cancelar
														conta</a></li>
											</ul></li>
								...
								<div class="panel panel-default">
									<div class="panel-body min-area">
										<div class="text-center">
											...
											<a href="user-adress-update.jsp" class="btn btn-warning">
												Alterar <i class="fa fa-chevron-right"></i>
											</a>
										</div>
									</div>
								</div>
						...
						<div class="col-sm-6">
							<div class="box">
								<div class="panel panel-default">
									<div class="panel-body min-area">
										<div class="text-center">
											<p class="lead">Cadastrar novo endereço?</p>

											</a> <a href="user-adress-new.jsp" class="btn btn-success">
												Novo <i class="fa fa-chevron-right"></i>
											</a>
										</div>
									</div>
								</div>
							...
							<div class="panel panel-default">
								<div class="panel-body">
									<div class="col-sm-6">
										<div class="text-center">
											<p class="lead">
												Listar seus enderços? <a href="order-conclusion.jsp"
													class="btn btn-info"> Listar <i
