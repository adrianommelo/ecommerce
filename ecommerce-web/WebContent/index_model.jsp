	...
	<div class="container">
		<div class="col-md-3">
			<div class="panel panel-default">
				<div class="panel-body" style="min-height: 500px;"></div>
			</div>
		</div>
										...
										<div class="panel-body">
											<div class="text-center">
												<a type="submit" class="btn btn-warning"
													href="index-cliente-logado.jsp"> Adicionar ao carrinho</a>
												<a type="submit" class="btn btn-success"
													href="index-cliente-logado.jsp"> Comprar</a>
											</div>
										</div>
									</div>
								</div>
								<div class="col-md-12">
									<div class="panel panel-default">
										<div class="panel-body">
											...
											<div class="col-md-6">
											<label for="txtCalcFrete">Calcular Frete</label>
												<input
