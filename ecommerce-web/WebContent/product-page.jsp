...
<body>
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="image">
				<img src="resources/img/motog4_play_md.png" alt=""
		...
		<div class="col-md-12">
			<div class="panel ">
				<div class="panel-body">
					<p class="lead">Descrição Produto</p>
					<hr>
					<div class="col-md-12">
						<div class="panel panel-list">
							<div class="panel-body">
								<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
									...
									Aliquam erat volutpat. Nunc auctor. Mauris pretium quam et
									urna. Fusce nibh. Duis risus. Curabitur sagittis hendrerit
									ante. Aliquam erat volutpat. Vestibulum erat nulla, ullamcorper
									nec, rutrum non, nonummy ac, erat. Duis condimentum augue id
									magna semper rutrum. Nullam justo enim, consectetuer nec,
									ullamcorper ac, vestibulum in, elit. Proin pede metus,
